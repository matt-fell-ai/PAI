...
curl -X POST http://localhost:8888/notify \
  ...
  -d '{"message":"[💥 excited] Found the **actual** bug!","voice_id":"s3TPKV1kjDlVtZbl4Ksh","title":"PAI"}'

# Test markdown prosody
curl -X POST http://localhost:8888/notify \
  -H "Content-Type: application/json" \
  -d '{"message":"Wait... I found something **critical**!","voice_id":"s3TPKV1kjDlVtZbl4Ksh","title":"PAI"}'

# Test combined
curl -X POST http://localhost:8888/notify \
  -H "Content-Type: application/json" \
  -d '{"message":"[✨ success] Deployment **complete** -- all systems operational!","voice_id":"s3TPKV1kjDlVtZbl4Ksh","title":"PAI"}'
```
