...
## Overview
This directory contains the 51+ modular capabilities that empower the PAI. Each skill is a self-contained unit of intelligence.
...
| **CORE** | PAI (Personal AI Infrastructure) - Your AI system core. Platform-agnostic and bridge-enabled. AUTO-LOADS at session start. |
| **Citadel** | Manages decentralized assets, cold-storage keys, and your digital "Fortress." USE WHEN you are managing high-value assets or updating security protocols. |
...
| **Pulse** | A PAI modular skill. |
| **Refactor** | A PAI modular skill. |
...
| **Vault** | A PAI modular skill. |
| **Vibe** | A PAI modular skill. |
...
| **Voice** | A PAI modular skill. |

## Directory Structure
Each skill contains a `SKILL.md` (instructions) and a `tools/` directory (CLI scripts).
