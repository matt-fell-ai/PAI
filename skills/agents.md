...
## Overview
This directory contains the modular capabilities that empower the PAI. Each skill is a self-contained unit of intelligence.
...
| **Vibe** | A PAI modular skill for vibe. |
...
| **Voice** | A PAI modular skill for voice. |
